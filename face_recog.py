...
f_04 = np.load('face_04.npy').reshape((20, 50*50*3))
f_05 = np.load('face_05.npy').reshape((20, 50*50*3))


print(f_01.shape, f_02.shape, f_03.shape, f_04.shape, f_05.shape)
...
labels[40:60, :] = 2.0	# last 20 for laksh (2)
labels[60:80, :] = 3.0
labels[80:, :] = 4.0

# combine all info into one data array
data = np.concatenate([f_01, f_02, f_03, f_04, f_05])	# (60, 7500)
